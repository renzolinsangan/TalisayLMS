            ...
            <div class="col-12 grid-margin stretch-card" style="margin-left: -20px;">
              <div class="card">
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      <h1 class="card-title" style="font-size: 30px; margin-left: 10px;">Students List</h1>
                      <a href="create_student.php" class="btn btn-success" style="margin-left: 10px;">Add New
                        Student</a>
                    </div>
                  </div>
                </div>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                              ...
                              <tr>
                                ...
                                <td style="font-size: 18px;">
                                  <a href="edit_student.php?updateid=<?php echo $row['user_id'] ?>" class="link-dark"
                                    style="margin-right: 5px;"><i class="bi bi-pencil-square"></i></a>
                                  <a href="delete_student.php?deleteid=<?php echo $row['user_id'] ?>" class="link-dark"><i
