    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="header-links" style="overflow-x: auto; white-space: nowrap;">
          <a href="student_report.php" class="abm" style="margin-left: 5vh;">All</a>
          <a href="student_reportstem.php" class="stem">STEM</a>
          <a href="student_reporthumss.php" class="humss">HUMSS</a>
          <a href="student_reportabm.php" class="nav-link active">ABM</a>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="card-body">
                        <h1 class="card-title" style="font-size: 30px; margin-left: 10px; margin-bottom: -20px;">ABM students</h1>
                      </div>
                    </div>
                  </div>
                  <div class="card">
                          ...
                          <div class="table-responsive">
                            ...
                            style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                              ...
                              <tbody>
                                <?php
                                include("db_conn.php");
                                $sql = "SELECT * FROM user_account WHERE usertype='student' AND department='abm'";
