    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="header-links" style="overflow-x: auto; white-space: nowrap;">
          <a href="student_report.php" class="stem" style="margin-left: 5vh;">All</a>
          <a href="student_reportstem.php" class="nav-link active">STEM</a>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="card-body">
                        <h1 class="card-title" style="font-size: 30px; margin-left: 10px; margin-bottom: -20px;">STEM students</h1>
                      </div>
                    </div>
                  </div>
                  <div class="card">
                          ...
                          <div class="table-responsive">
                            ...
                            style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                              ...
                              <tbody>
                                <?php
                                include("db_conn.php");
                                $sql = "SELECT * FROM user_account WHERE usertype='student' AND department='stem'";
