    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="header-links">
          <a href="grade_report.php" class="abm" style="margin-left: 5vh;">All</a>
          <a href="grade_reportstem.php" class="stem">STEM</a>
          <a href="grade_reporthumss.php" class="humss">HUMSS</a>
          <a href="grade_reportabm.php" class="nav-link active">ABM</a>
            ...
            <div class="col-12 grid-margin stretch-card" style="margin-left: -20px;">
              <div class="card">
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      <h1 class="card-title" style="font-size: 30px; margin-left: 10px;">ABM Report of Grades</h1>
