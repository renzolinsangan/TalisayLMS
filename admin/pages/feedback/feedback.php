    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col mb-4">
              <h2 style="margin-left: 8px;">Feedback & Requests</h2>
              <p class="text-body-secondary" style="margin-left: 8px;">(Users)</p>
            </div>
            <?php
            include("db_conn.php");
                    ...
                    <div class="col-md-12">
                      <div class="card-body">
                        ...
                        <div class="feedback_body">
                          <p style="margin-left: 5vh; font-size: 17px;">
                            <?php echo $row['details'] ?>
                          </p>
                        </div>
                        <div class="delete text-right">
                          <a href="delete_feedback.php?deleteid=<?php echo $row['feedback_id'] ?>" class="link-danger">
                            <i class="bi bi-trash-fill" style="font-size: 25px; width: 25px; height: 25px;"></i>
                          </a>
                        </div>
                      </div>
                    </div>
