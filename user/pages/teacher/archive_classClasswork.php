                          ...
                          <div class="col-12 grid-margin strech-card">
                            ...
                            <div id="<?php echo $collapseID ?>" class="collapse" aria-labelledby="accordionHeading">
                              ...
                              background-color: transparent; border-radius: 0%;">
                                <a href="archive_assignmentReview.php?class_id=<?php echo $class_id ?>&assignment_id=<?php echo $assignment_id ?>"
                        ...
                        <div class="topic-question">
                          <div class="col-12 grid-margin strech-card">
                            ...
                            <div id="<?php echo $collapseID ?>" class="collapse" aria-labelledby="accordionHeading">
                              ...
                              <div class="card-footer" style="border: 1px solid #ccc; 
                              background-color: transparent; border-radius: 0%;">
                                <a href="archive_questionReview.php?class_id=<?php echo $class_id ?>&question_id=<?php echo $question_id ?>"
                                  style="color: green; margin-left: 8px; text-decoration: none;">
                                  View Question
                                </a>
                              </div>
                        ...
                        ?>
                          ...
                          <div class="col-12 grid-margin strech-card">
                            ...
                            <div id="<?php echo $collapseID ?>" class="collapse" aria-labelledby="accordionHeading">
                              ...
                              <div class="card-footer" style="border: 1px solid #ccc; 
                              background-color: transparent; border-radius: 0%;">
                                <a href="archive_quizReview.php?class_id=<?php echo $class_id ?>&quiz_id=<?php echo $quiz_id?>"
                                style="color: green; margin-left: 8px; text-decoration: none;">
                                  View Quiz
                                </a>
                              </div>
                        ...
                        ?>
                          ...
                          <div class="col-12 grid-margin strech-card">
                            ...
                            <div id="<?php echo $collapseID ?>" class="collapse" aria-labelledby="accordionHeading">
                              ...
                              <div class="card-footer" style="border: 1px solid #ccc; 
                              background-color: transparent; border-radius: 0%;">
                                <a href="archive_examReview.php?class_id=<?php echo $class_id ?>&exam_id=<?php echo $exam_id?>"
                                style="color: green; margin-left: 8px; text-decoration: none;">
                                  View Exam
                                </a>
                              </div>
