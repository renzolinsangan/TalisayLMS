              ...
              <div class="row">
                <div class="col-md-3 mb-3">
                  <div class="card"
                    ...
                    <a href="archivetoreview.php?class_id=<?php echo $class_id ?>" class="create mt-2"
                      style="margin-left: auto; color: green;">To-review</a>
                  </div>
                </div>
                <div class="col">
                  <?php
                  ...
                  if (empty($combined_results)) {
                    ...
                    <div class="d-grid gap-2 col-13 mx-auto mb-4">
                      <span class="announce" type="button" style="text-decoration: none;">
                        This class is archived, you can't create any materials from classwork anymore.
                      </span>
                    </div>
                    <?php
                  } else {
