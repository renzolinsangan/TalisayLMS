      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-4" style="margin-left: 111vh">
              <div class="row">
                <div class="col">
                  <div class="card-body">
                    <p class="text-body-secondary" style="font-size: 14px; margin-top: -20px;">
          ...
          <div class="row">
            ...
            $sql = "SELECT * FROM section WHERE teacher_id = ? AND strand = ?";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              if ($themeData) {
                ...
                // Set a default theme in case no theme is found
                $theme = 'background-color: green'; // You can change this to your default image URL
              }
              ?>
