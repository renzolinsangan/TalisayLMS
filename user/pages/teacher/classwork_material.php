...
if (isset($_POST['post_button'])) {
  ...
  if (isset($_SESSION['temp_file_id'])) {
    ...
    $sql = "INSERT INTO classwork_material (title, description, class_name, student, class_topic, class_id, teacher_id, date, link, file, youtube) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmtinsert = $conn->prepare($sql);
    $result = $stmtinsert->execute([$title, $description, $class_name, $student, $class_topic, $class_id, $teacher_id, $date, $link, $file_name, $youtube]);
    ...
    $sql = "INSERT INTO classwork_material (title, description, class_name, student, class_topic, class_id, teacher_id, date) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmtinsert = $conn->prepare($sql);
    $result = $stmtinsert->execute([$title, $description, $class_name, $student, $class_topic, $class_id, $teacher_id, $date]);
    ...
    <nav class="navbar navbar-light fs-3 mb-5">
      <div class="d-flex align-items-center justify-content-between w-100">
        <div class="d-flex align-items-center">
          ...
          <p class="text-body-secondary" style="margin-top: 10px; font-size: 22px;">Material</p>
        </div>
        <div>
          <div class="btn-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                      <div class="card">
                        ...
                        <a
                          href="delete_mainYoutubeMaterial.php?deleteid=<?php echo $material_upload_id ?>&class_id=<?php echo $class_id ?>">
                          <div class="row mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mb-3">
                    <div class="card">
                      ...
                      <a
                        href="delete_mainFileMaterial.php?deleteid=<?php echo $material_upload_id ?>&class_id=<?php echo $class_id ?>">
                        <div class="row mb-3">
                          <div class="col text-end" style="margin-right: 15px; font-size: 25px; color: red;">
                            <i class="bi bi-trash-fill"></i>
                          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mb-3">
                    <div class="card">
                      ...
                      <a
                        href="delete_mainLinkMaterial.php?deleteid=<?php echo $material_upload_id ?>&class_id=<?php echo $class_id ?>">
                        <div class="row mb-3">
                          <div class="col text-end" style="margin-right: 15px; font-size: 25px; color: red;">
                            <i class="bi bi-trash-fill"></i>
                          </div>
          ...
          <div class="col-md-4" id="right-content">
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-4">
                <select id="multipleSelect" name="class_topic" placeholder="Select Topics" data-search="true"
                  data-silent-initial-value-set="true" style="height: 45px;">
