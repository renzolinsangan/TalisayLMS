...
if (isset($_POST['add_teacher'])) {
  ...
  $sql_addFriend = "INSERT INTO teacher (user_id, teacher_id, name, date) VALUES (?, ?, ?, NOW())";
                  ...
                  <div class="row justify-content-between">
                    <div class="col-md-3">
                      <div class="circle-image"
                        style="margin-left: 20px; background-image: url('<?php echo empty($otherProfile) ? '../teacher/images/profile.png' : '../teacher/assets/image/' . $otherProfile; ?>');">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="d-flex flex-column justify-content-between h-100">
                        ...
                        if (isset($_POST['unfriend'])) {
                          $sql_deleteFriendship = "DELETE FROM teacher WHERE (user_id = ? AND teacher_id = ?) OR (user_id = ? AND teacher_id = ?)";
                        ...
                        $sql_addedFriend = "SELECT teacher_id FROM teacher WHERE user_id = ? AND teacher_id = ?";
                        ...
                        <div class="text-right">
                          <?php if ($isFriend): ?>
                            <button class="btn removeTeacher" type="button" data-bs-toggle="modal"
                              data-bs-target="#staticBackdropUnfriend" style="color: red;">
                              <i class="bi bi-trash"></i> Remove Teacher
                            </button>
                          <?php else: ?>
                            <button class="btn add-teacher" type="button" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <h3>Remove
                                    <?php echo $firstname . ' ' . $lastname ?> from your teacher list.
                                  </h3>
                                  <p class="text-body-secondary">If you wish to cancel, press the x button.</p>
                                </div>
                                <div class="modal-footer" style="border: none;">
                                  <button type="submit" name="unfriend" class="btn btn-danger">Remove</button>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="modal fade" id="staticBackdropAddFriend" data-bs-backdrop="static"
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <h3>Add
                                    <?php echo $firstname . ' ' . $lastname ?> as your teacher.
                                  </h3>
                                  <p class="text-body-secondary">If you wish to cancel, press the x button.</p>
                                </div>
                                <div class="modal-footer" style="border: none;">
