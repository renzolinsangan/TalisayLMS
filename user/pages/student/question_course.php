...
$sqlQuestionScore = "SELECT score FROM questiongrade 
WHERE questionTitle = ? AND question_id = ? AND student_id = ?";
$stmtQuestionScore = $db->prepare($sqlQuestionScore);
$stmtQuestionScore->execute([$title, $question_id, $user_id]);
$questionScore = $stmtQuestionScore->fetchColumn();
?>
<!doctype html>
<html lang="en">
