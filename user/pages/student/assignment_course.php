...
$sqlAssignmentScore = "SELECT score FROM assignmentgrade 
WHERE assignmentTitle = ? AND assignment_id = ? AND student_id = ?";
$stmtAssignmentScore = $db->prepare($sqlAssignmentScore);
$stmtAssignmentScore->execute([$title, $assignment_id, $user_id]);
$assignmentScore = $stmtAssignmentScore->fetchColumn();
?>
<!doctype html>
<html lang="en">
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/ass_course.css">
          ...
          <div class="col-md-4 mt-5">
            <div class="card">
              ...
              if (isset($_POST['mark_done'])) {
                ...
                $assignment_course_upload_id = isset($assignment_course_upload_id) ? $assignment_course_upload_id : '';
              ...
              <div class="row justify-content-center align-items-center mt-2 mb-4">
                <div class="d-grid gap-2 col-11 mx-auto">
                  ...
                  <button class="btn btn-success" type="button"
                    style="<?php echo $assignment_answer_data ? '' : 'display: none;' ?>">Assignment Submitted</button>
