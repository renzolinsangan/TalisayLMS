...
if (isset($_POST['add_link'])) {
  ...
  $sql = "INSERT INTO assignment_course_upload (link, class_id, assignment_id) VALUES (?, ?, ?)";
  $stmtinsert = $db->prepare($sql);
  $result = $stmtinsert->execute([$link, $class_id, $assignment_id]);
  ...
  if (isset($_FILES['file'])) {
    ...
    if ($file['error'] === UPLOAD_ERR_OK) {
      ...
      if (move_uploaded_file($tmp_name, $upload_directory)) {
        $sql = "INSERT INTO assignment_course_upload (file, class_id, assignment_id) VALUES (?, ?, ?)";
        $stmt = $db->prepare($sql);
        $result = $stmt->execute([$file_name, $class_id, $assignment_id]);
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/course_assignment.css">
...
<body>
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <hr class="divider"
        style="border-top: 2px solid black; width: 90%; margin-top: 30px; margin-left: 15px; margin-bottom: -20px;">
      <div class="row justify-content-left align-items-center mb-5">
          ...
          <div class="card">
            ...
            <div class="row justify-content-center align-items-center mt-2 mb-4">
              <div class="d-grid gap-2 col-11 mx-auto">
                ...
                <button class="btn btn-success" type="button">Mark as Done</button>
              </div>
            </div>
          </div>
        </div>
