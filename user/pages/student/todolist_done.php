        ...
        <div class="content-wrapper align-items-center justify-content-center" style="margin-top: 10vh;">
          ...
          <div class="row">
            <div class="col">
              ...
              $sql_assignment = "SELECT assignment_id, title, date FROM classwork_assignment WHERE teacher_id = ? AND class_name = ? AND assignment_status = 'turned in'";
              ...
              $sql_question = "SELECT question_id, title, date FROM classwork_question WHERE teacher_id = ? AND class_name = ? AND question_status = 'turned in'";
