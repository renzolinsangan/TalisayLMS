              ...
              <div class="card position-relative">
                <div class="card-body">
                  <div class="col-md-5 grid-margin transparent">
                    <h2>Awards</h2>
                    <p class="text-body-secondary">User has 1 Award.</p>
                    <a href="" class="course">
                      <div class="card card-tale text-center" style="height: 50vh; margin-top: 4vh;">
                        <div class="circle-image">
                          <img src="images/medal.svg" alt="Circular Image">
                        </div>
                        <h2 style="margin-top: 2vh;">Quiz Wizard</h2>
                        <p>Achieve in General Physics in March 12, 2023.</p>
                      </div>
                    </a>
                  </div>
                </div>
