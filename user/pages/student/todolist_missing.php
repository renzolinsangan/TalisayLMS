      ...
      <div class="main-panel">
        <div class="header-sticky">
          <div class="header-links">
            ...
            <a href="todolist_assigned.php?class_id=<?php echo $class_id ?>" class="people" style="margin-left: 2vh;">Assigned</a>
            <a href="todolist_missing.php?class_id=<?php echo $class_id ?>" class="nav-link active">Missing</a>
        ...
        <div class="content-wrapper align-items-center justify-content-center" style="margin-top: 10vh;">
          ...
          <div class="row">
            <div class="col">
                ...
                $sql_assignment = "SELECT assignment_id, title, due_date FROM classwork_assignment WHERE 
                teacher_id = ? AND class_name = ? AND assignment_status = 'missing'";
                ...
                $sql_question = "SELECT question_id, title, due_date FROM classwork_question WHERE 
                teacher_id = ? AND class_name = ? AND question_status = 'missing'";
